...
links to a variety of lists of academics in different disciplines. Because many of the lists are based on
      ...
      to create an app to browse the lists.
      This app does not maintain a copy of the data; the lists are loaded directly into your web browser. 
      </p>
...
<p>    I'm hoping to add that soon. For now, if you want to be on these lists, use the list of data sources below or head on over 
  to  <a href="https://nathanlesage.github.io/academics-on-mastodon/" target="_blank" rel="noreferrer">
      ...
      <ol className="numbered">
        ...
        <li>Create an option for owners to store lists as part of this app.</li>
      </ol>
  <h2>Do I have to login?</h2>
  <p>You can browse public information without logging in. In order to follow and see non-public profiles you have permissions to see, you need to log into your mastodon instance. I would like to add an "Export to CSV" option so that
